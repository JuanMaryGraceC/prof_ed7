...
**Solution**.
Let $y=F(x)$ be an equation of the curve. The slope of the tangent line $m_{TL}$ at a point $(x,y)$ on the graph of the curve is given by $F'(x)=3\sqrt x$. We have $$F(x)=\int 3x^\frac{1}{2}dx=2x^\frac{3}{2}+C.
